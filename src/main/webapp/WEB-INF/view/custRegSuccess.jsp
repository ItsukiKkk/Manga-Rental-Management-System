		...
		<div class="layui-page-header">
            <div class="pagewrap">
                <span class="layui-breadcrumb">
                  <a>会員登録</a>
                  <a>登録確認</a>
                  <a><cite>会員登録完了</cite></a>
                </span>
                <h2 class="title">会員登録完了</h2>
            </div>
        </div>
		<div class="layui-row">
				...
				<div class="layui-card-header"></div>
					<form class="layui-form layui-card-body" action="toCustRegSuccess" method="post">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="custName" class="layui-input" value="${customer.lastname} ${customer.firstname}" readonly/>
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">&nbsp;</label>
							<div>
								<h2><b><font color="#149BD3">登録が完了しました。</font></b></h2>
							</div>
						</div>
						<div class="layui-form-item" id="toMenuBtn">
							<label class="layui-form-label">&nbsp;</label>
							<button type="button" class="layui-btn layui-btn-primary" data-url="${pageContext.request.contextPath}/custRegForm">メインメニュー</button>
						</div>
					</form>
				</div>
			</div>
