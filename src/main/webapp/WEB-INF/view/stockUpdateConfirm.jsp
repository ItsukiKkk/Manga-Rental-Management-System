		...
		<div class="layui-row">
			<div class="layui-card">				
				<div class="layui-card-header">確認</div>
					<form class="layui-form layui-card-body" action="${pageContext.request.contextPath}/toStockUpdateSuccess" method="post">
	...
	<script>
		...
		*/
	    function toUpdateForm() {
	        window.location.href = "${pageContext.request.contextPath}/toStockUpdateForm";
	    }
	    /*
			エラーメッセージ
		*/
