				...
				<div class="layui-card-header">完了</div>
					<form class="layui-form layui-card-body" action="${pageContext.request.contextPath}/toStockRegForm" method="post">
						...
						<div class="layui-form-item">
							...
							<div>
								<h2><b><font color="#149BD3">${category.category}</font>を登録しました。</b></h2>
							</div>
						</div>
						<div class="layui-form-item" id="toMenuBtn">
							<label class="layui-form-label">&nbsp;</label>
							<button type="button" class="layui-btn layui-btn-primary" data-url="${pageContext.request.contextPath}/categoryRegForm">メインメニュー</button>
						</div>
					</form>
				</div>
			</div>
