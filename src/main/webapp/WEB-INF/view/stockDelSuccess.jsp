				...
				<div class="layui-card-header">完了</div>
					<form class="layui-form layui-card-body" action="${pageContext.request.contextPath}/toTitleSelList" method="post">
						<div class="layui-form-item">							
							<input type="hidden" name="stockNo" class="layui-input" value="${delStock.stockNo}"/>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">&nbsp;</label>
							<div>
								<h2><b><font color="#149BD3">在庫番号：${delStock.stockNo}</font>を削除しました。</b></h2>
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">&nbsp;</label>
							<button type="button" class="layui-btn layui-btn-primary" id="toSelListBtn">在庫一覧</button>
						</div>
