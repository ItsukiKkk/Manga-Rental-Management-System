		...
		<div class="layui-page-header">
            <div class="pagewrap">
                <span class="layui-breadcrumb">
                  ...
                  <a>会員詳細</a>
                  <a>会員退会確認</a>
                  <a><cite>会員退会完了</cite></a>
                </span>
                <h2 class="title">会員退会完了</h2>
            </div>
        </div>
		<div class="layui-row">
				...
				<div class="layui-card-header"></div>
					<form class="layui-form layui-card-body" action="" method="post">
						...
						<div class="layui-form-item" id="toMenuBtn">
							<label class="layui-form-label">&nbsp;</label>
							<button type="button" class="layui-btn layui-btn-primary" data-url="${pageContext.request.contextPath}/custCancleConfirm">メインメニュー</button>	
						</div>
					</form>
				</div>
			</div>
